...
export interface ActionVePendleStaticInterface extends utils.Interface {
...
export interface ActionVePendleStatic extends BaseContract {
  contractName: "ActionVePendleStatic";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ActionVePendleStaticInterface;
