...
import type { IPAllEventsV3, IPAllEventsV3Interface } from "../IPAllEventsV3";
...
export class IPAllEventsV3__factory {
  static readonly abi = _abi;
  static createInterface(): IPAllEventsV3Interface {
    return new utils.Interface(_abi) as IPAllEventsV3Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPAllEventsV3 {
    return new Contract(address, _abi, signerOrProvider) as IPAllEventsV3;
  }
}
