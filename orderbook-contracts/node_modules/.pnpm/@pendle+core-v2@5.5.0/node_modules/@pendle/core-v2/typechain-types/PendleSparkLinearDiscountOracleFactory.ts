...
export interface PendleSparkLinearDiscountOracleFactoryInterface
...
export interface PendleSparkLinearDiscountOracleFactory extends BaseContract {
  ...
  interface: PendleSparkLinearDiscountOracleFactoryInterface;
  ...
  functions: {
    create(
      _pt: string,
      _baseDiscountPerYear: BigNumberish,
