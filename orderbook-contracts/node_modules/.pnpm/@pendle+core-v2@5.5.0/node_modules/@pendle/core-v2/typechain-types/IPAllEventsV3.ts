...
export interface IPAllEventsV3Interface extends utils.Interface {
  contractName: "IPAllEventsV3";
  functions: {};
...
export interface IPAllEventsV3 extends BaseContract {
  contractName: "IPAllEventsV3";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPAllEventsV3Interface;
