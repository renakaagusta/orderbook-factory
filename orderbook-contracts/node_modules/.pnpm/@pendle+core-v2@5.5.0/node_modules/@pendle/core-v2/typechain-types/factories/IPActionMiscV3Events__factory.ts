...
import type {
  ...
  IPActionMiscV3EventsInterface,
} from "../IPActionMiscV3Events";
...
export class IPActionMiscV3Events__factory {
  static readonly abi = _abi;
  static createInterface(): IPActionMiscV3EventsInterface {
    return new utils.Interface(_abi) as IPActionMiscV3EventsInterface;
  }
  static connect(
    address: string,
