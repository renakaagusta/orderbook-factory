...
export class IPActionSimple__factory {
  static readonly abi = _abi;
  static createInterface(): IPActionSimpleInterface {
    return new utils.Interface(_abi) as IPActionSimpleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPActionSimple {
    return new Contract(address, _abi, signerOrProvider) as IPActionSimple;
  }
}
